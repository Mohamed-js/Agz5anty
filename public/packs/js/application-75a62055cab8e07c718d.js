...
var map = {
	"./orders_channel.js": "./app/javascript/channels/orders_channel.js"
};
...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("OrdersChannel", {
...
function refresh() {
  ...
  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      var orders = JSON.parse(this.responseText); //   orders.forEach((order) => {
...
/******/ });
//# sourceMappingURL=application-75a62055cab8e07c718d.js.map