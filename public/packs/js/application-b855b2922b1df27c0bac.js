  ...
  req.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
      ...
      orders.forEach(function (order) {
        document.getElementById("orders-table").innerHTML += "\n        <tr>\n        <td> ".concat(order.item, " </td>");

        if (order.image_url) {
          document.getElementById("orders-table").innerHTML += " <td> <img src='".concat(order.image_url, "' alt='").concat(order.image_url, "' ></td>");
        }

        document.getElementById("orders-table").innerHTML += "\n        <td> ".concat(order.quantity, " </td>\n        <td> ").concat(order.tprice, " </td>\n        <td> ").concat(order.user.name, " </td>\n        <td> order.phone </td>\n        <td> order.city </td>\n        <td> order.center </td>\n        <td> order.address </td>\n        <td> link_to 'Sold', \"/sold/#{order.id}\", method: :post </td>\n        <td> link_to 'Edit', edit_order_path(order) </td>\n        <td> link_to 'Destroy', order, method: :delete</td>\n      </tr>\n      ");
      });
...
/******/ });
//# sourceMappingURL=application-b855b2922b1df27c0bac.js.map